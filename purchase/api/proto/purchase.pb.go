...
const (
	...
	PurchaseResponse_TimeOut    PurchaseResponse_Error = 5
)
...
func (PurchaseResponse_Error) EnumDescriptor() ([]byte, []int) {
	return file_purchase_api_proto_purchase_proto_rawDescGZIP(), []int{3, 0}
}
...
type PayByWalletRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserPhoneNo  string `protobuf:"bytes,1,opt,name=user_phone_no,json=userPhoneNo,proto3" json:"user_phone_no,omitempty"`
	WalletNumber string `protobuf:"bytes,2,opt,name=wallet_number,json=walletNumber,proto3" json:"wallet_number,omitempty"`
	Amount       int32  `protobuf:"varint,3,opt,name=amount,proto3" json:"amount,omitempty"`
}

func (x *PayByWalletRequest) Reset() {
	*x = PayByWalletRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PayByWalletRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayByWalletRequest) ProtoMessage() {}

func (x *PayByWalletRequest) ProtoReflect() protoreflect.Message {
	mi := &file_purchase_api_proto_purchase_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayByWalletRequest.ProtoReflect.Descriptor instead.
func (*PayByWalletRequest) Descriptor() ([]byte, []int) {
	return file_purchase_api_proto_purchase_proto_rawDescGZIP(), []int{1}
}

func (x *PayByWalletRequest) GetUserPhoneNo() string {
	if x != nil {
		return x.UserPhoneNo
	}
	return ""
...
func (x *PayByWalletRequest) GetWalletNumber() string {
	if x != nil {
...
func (x *PayByWalletRequest) GetAmount() int32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
type PayByCreditRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PayByCreditRequest) Reset() {
	*x = PayByCreditRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_purchase_api_proto_purchase_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *PayByCreditRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayByCreditRequest) ProtoMessage() {}

func (x *PayByCreditRequest) ProtoReflect() protoreflect.Message {
	mi := &file_purchase_api_proto_purchase_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayByCreditRequest.ProtoReflect.Descriptor instead.
func (*PayByCreditRequest) Descriptor() ([]byte, []int) {
	return file_purchase_api_proto_purchase_proto_rawDescGZIP(), []int{2}
}

func (x *PayByCreditRequest) GetUserPhoneNo() string {
	if x != nil {
		return x.UserPhoneNo
	}
	return ""
...
func (x *PayByCreditRequest) GetCreditId() string {
	if x != nil {
		return x.CreditId
	}
	return ""
...
func (x *PayByCreditRequest) GetAmount() int32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *PurchaseResponse) Reset() {
	*x = PurchaseResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_purchase_api_proto_purchase_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PurchaseResponse) Descriptor() ([]byte, []int) {
	return file_purchase_api_proto_purchase_proto_rawDescGZIP(), []int{3}
}
...
var file_purchase_api_proto_purchase_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x12, 0x41, 0x0a, 0x0b, 0x50, 0x61, 0x79, 0x42, 0x79, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74,
	0x12, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x50, 0x61, 0x79, 0x42, 0x79, 0x43, 0x72,
	0x65, 0x64, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x14, 0x5a, 0x12, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65,
...
var file_purchase_api_proto_purchase_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_purchase_api_proto_purchase_proto_goTypes = []interface{}{
	...
	(*PayByWalletRequest)(nil),  // 2: proto.PayByWalletRequest
	(*PayByCreditRequest)(nil),  // 3: proto.PayByCreditRequest
	(*PurchaseResponse)(nil),    // 4: proto.PurchaseResponse
}
var file_purchase_api_proto_purchase_proto_depIdxs = []int32{
	...
	2, // 2: proto.Purchase.PayByWallet:input_type -> proto.PayByWalletRequest
	3, // 3: proto.Purchase.PayByCredit:input_type -> proto.PayByCreditRequest
	4, // 4: proto.Purchase.PayByCart:output_type -> proto.PurchaseResponse
	4, // 5: proto.Purchase.PayByWallet:output_type -> proto.PurchaseResponse
	4, // 6: proto.Purchase.PayByCredit:output_type -> proto.PurchaseResponse
...
func file_purchase_api_proto_purchase_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_purchase_api_proto_purchase_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PayByWalletRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_purchase_api_proto_purchase_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PayByCreditRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_purchase_api_proto_purchase_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
...
type PurchaseClient interface {
	...
	PayByWallet(ctx context.Context, in *PayByWalletRequest, opts ...grpc.CallOption) (*PurchaseResponse, error)
	PayByCredit(ctx context.Context, in *PayByCreditRequest, opts ...grpc.CallOption) (*PurchaseResponse, error)
}
...
func (c *purchaseClient) PayByWallet(ctx context.Context, in *PayByWalletRequest, opts ...grpc.CallOption) (*PurchaseResponse, error) {
	out := new(PurchaseResponse)
	err := c.cc.Invoke(ctx, "/proto.Purchase/PayByWallet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *purchaseClient) PayByCredit(ctx context.Context, in *PayByCreditRequest, opts ...grpc.CallOption) (*PurchaseResponse, error) {
	out := new(PurchaseResponse)
	err := c.cc.Invoke(ctx, "/proto.Purchase/PayByCredit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PurchaseServer interface {
	...
	PayByWallet(context.Context, *PayByWalletRequest) (*PurchaseResponse, error)
	PayByCredit(context.Context, *PayByCreditRequest) (*PurchaseResponse, error)
}
...
func (*UnimplementedPurchaseServer) PayByWallet(context.Context, *PayByWalletRequest) (*PurchaseResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PayByWallet not implemented")
}
func (*UnimplementedPurchaseServer) PayByCredit(context.Context, *PayByCreditRequest) (*PurchaseResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PayByCredit not implemented")
}
...
func _Purchase_PayByWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PayByWalletRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PurchaseServer).PayByWallet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Purchase/PayByWallet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PurchaseServer).PayByWallet(ctx, req.(*PayByWalletRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Purchase_PayByCredit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PayByCreditRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PurchaseServer).PayByCredit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Purchase/PayByCredit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PurchaseServer).PayByCredit(ctx, req.(*PayByCreditRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Purchase_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Purchase_PayByWallet_Handler,
		},
		{
			MethodName: "PayByCredit",
			Handler:    _Purchase_PayByCredit_Handler,
		},
	},
